        ...
        <div class="container">
            ...
            <form action="/pizza-order.jsp" method="POST">
                ...
                <div class="form-check">
                    <input id="toppings1" name="toppings" class="form-check-input" type="checkbox" value="">
                    <label class="form-check-label" for="toppings1">Cheese</label>
                </div>
                <div class="form-check">
                    <input id="toppings2" name="toppings" class="form-check-input" type="checkbox" value="">
                    <label class="form-check-label" for="toppings2">Pepperoni</label>
                </div>
                <div class="form-check">
                    <input id="toppings3" name="toppings" class="form-check-input" type="checkbox" value="">
                    <label class="form-check-label" for="toppings3">Italian Sausage</label>
                </div>
                <div class="form-check">
                    <input id="toppings4" name="toppings" class="form-check-input" type="checkbox" value="">
                    <label class="form-check-label" for="toppings4">Ham</label>
                </div>
                <div class="form-check">
                    <input id="toppings5" name="toppings" class="form-check-input" type="checkbox" value="">
                    <label class="form-check-label" for="toppings5">Mushrooms</label>
                </div>
                <div class="form-check">
                    <input id="toppings6" name="toppings" class="form-check-input" type="checkbox" value="">
